...
public class ContentAdapter extends BaseAdapter {
    ...
    private int layout;
    List<com.example.news.ContentItem> contentItemList;

    public ContentAdapter(Context context, int layout, List<com.example.news.ContentItem> contentItemList) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        com.example.news.ContentItem content = contentItemList.get(i);
